        ...
        <div className="bg-hrtColorWhiteTrans border-2 border-hrtColorPink rounded-lg relative ">
          <div className="overflow-auto guideHeight scrollbar-hide">
            <div className='mb-12 mt-8 mx-4'>
              <p className='text-right mr-8 mb-4 text-hrtColorOutline700'>{opsNum + 1}/9</p>
              ...
              {Questions[opsNum].answers.map((answer) => {
                return (
                  <div 
                    key={answer.id}
                    id={answer.type} 
                    className={`mx-auto h-auto w-64 my-4 py-2 flex justify-center items-center border-2 cursor-pointer ${answer.id === 1 ? 'bg-hrtColorYellow border-hrtColorPurple' : 'bg-hrtColorPurple border-hrtColorYellow'}`} 
