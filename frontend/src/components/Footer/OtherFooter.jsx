...
const OtherFooter = () => {
  ...
  const [isSendLetterModalVisible, setIsSendLetterModalVisible] = useState(false);
  ...
  return (
    <div className={style.wrap}>
      ...
      {isModalVisible && <PostCardBox cancelClick={closeModal} onSelectButtonClick={handleSelectButtonClick}/>}
      {isSendLetterModalVisible && <SendLetter onClose={closeSendLetterModal} card={selectedPostCard}/>}
    </div>
  );
};
